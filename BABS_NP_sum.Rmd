...
Scores should be integers only (each subscale ranges from 0-12; total= 0-48). There are many instances of non-integr values, so printing a data frame with the incorrect values & subject IDs below.
